...
long long edp_delete_event(const char* event_id_utf8);
char* edp_member_profile(const char* member_id_utf8);
char* edp_export_json_for_event(const char* event_id_utf8);
char* edp_list_status_audit(const char* event_id_utf8_or_null, const char* attendance_id_utf8_or_null, long long limit);
long long edp_bulk_status_update(const char* event_id_utf8, const char* attendee_ids_csv_utf8, const char* new_status_utf8, bool event_in_progress, bool has_manager_override, const char* reason_utf8_or_null, const char* changed_by_utf8_or_null);
